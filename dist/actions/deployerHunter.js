...
export const deployerStatsAction = {
    ...
    description: "Chain-wide Pump.fun deployer stats — tracked_count (how many deployers are graded), signals_today, bonds_detected, the ecosystem bond_rate, and a per-tier count (elite/good/rising). Read this first to calibrate: a chain-wide bond rate of ~2% is what makes an elite deployer's 30% meaningful. Requires an msk_ key.",
    examples: [
...
export const deployerBestTokensAction = {
    ...
    description: "Best-performing recent tokens launched by RANKED (non-unranked) Pump.fun deployers, by peak market cap multiple over the alert price. Each row carries the deployer wallet and tier alongside mc_at_bond, peak_market_cap and mc_multiplier. Requires an msk_ key.",
    examples: [
