...
export const sniperRecentAction = {
  ...
  handler: async (agent: unknown, input: Parameters<typeof sniperRecent>[1]) => {
    try {
...
export const sniperByDeployerAction = {
  ...
  handler: async (agent: unknown, input: { wallet: string; limit?: number }) => {
    try {
...
export const sniperWatchlistAddAction = {
  ...
  handler: async (agent: unknown, input: { wallet?: string; wallets?: string[]; label?: string }) => {
    try {
