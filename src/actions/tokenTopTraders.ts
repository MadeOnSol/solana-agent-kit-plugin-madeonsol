...
export const tokenTopTradersAction = {
  ...
  description:
    "Get the wallets that made (or lost) the most on a Solana token, ranked by realized PnL or ROI, enriched with KOL and alpha-wallet reputation. limit PRO≤25/ULTRA≤100 (default 10); sort 'pnl' (default) or 'roi'; window_days 1-180 (default 90); min_bought_sol default 0.1. PRO/ULTRA only — BASIC receives HTTP 403.",
  examples: [
  ...
  handler: async (agent: unknown, input: { mint: string; limit?: number; sort?: "pnl" | "roi"; window_days?: number; min_bought_sol?: number }) => {
    try {
