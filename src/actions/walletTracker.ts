...
export const walletTrackerRemoveAction = {
  ...
  handler: async (agent: unknown, input: { wallet_address: string }) => {
    try {
...
export const walletTrackerTradesAction = {
  ...
  handler: async (agent: unknown, input: { wallet?: string; action?: "buy" | "sell"; event_type?: "swap" | "transfer"; limit?: number; order?: "slot" | "block_time"; before_slot?: number; before?: number }) => {
    try {
